            ...
            <footer className="main">
                ...
                <div className='bg-[#0b3b99] py-5'>
                    <div className='container flex gap-5 flex-col md:flex-row items-center justify-between'>
                        ...
                        <div className='grid grid-cols-2 w-full text-center px-28'>
                            {pages_respond?.data?.map((page) => (
                                <Link key={page._id} href={`/page/${page._id}`}>
                    ...
                    <p className='text-center text-white mt-5'>©️ 2025 Main Street Company. All rights reserved.</p>
                </div>
            </footer>
        </>
    );
