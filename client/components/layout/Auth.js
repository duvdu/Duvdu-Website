  ...
  const imageSources = [
    {
      ...
      h1: t(`on_boarding.title_1`),
      p: t(`on_boarding.desc_1`),
    },
    {
      img: "/assets/imgs/authswiper/login-2.png",
      h1: t(`on_boarding.title_2`),
      p: t(`on_boarding.desc_2`),
    },
    {
      img: "/assets/imgs/authswiper/login-3.png",
      h1: t(`on_boarding.title_3`),
      p: t(`on_boarding.desc_3`),
    },
  ];
          ...
          <div className="container">
            <div className="flex flex-col lg:flex-row gap-6 h-body py-9">
                ...
                <div className="left-side-auth lg:mt-0 h-full w-full">
                  <div className="flex h-full w-full">
                    <Swiper
                      ...
                      onSlideChange={() =>
                        setActive((active + 1) % imageSources.length)
                      }
                      loop={true}
                      autoplay={{ delay: 4000 }}
                      speed={1500}
                          ...
                          <div dir={i18n.language==='Arabic'?'rtl':'ltr'} className="relative min-h-[790px] lg:min-h-0 min-w-96 size-full">
                            <div className="absolute inset-0 flex flex-col auth-gradient px-[7px] sm:px-4 lg:px-16">
                              <div className="absolute bottom-20 ">
                                ...
                                <p className="text-white opacity-60 text-sm leading-6 capitalize">
                                  {source.p}
                                </p>
                              </div>
                            </div>
                            {location && (
                              <div
                                className="bg-cover border-top swipper-img h-full"
                                style={{
                                  backgroundImage: `url(${location}/${source.img})`,
                                }}
                              />
                            )}
                          </div>
              ...
              <div className="lg:w-7/12 xl:w-7/12 ">
                <div className="padding_eight_all bg-white dark:bg-[#1A1A1A] relative flex flex-col justify-center items-center rounded-lg h-auto sm:h-full">
                  <Link href="/">
                    <span className="as-Guest flex items-center cursor-pointer">
                      {t("Continue as a Guest")}
                      <Icon
                        name={lang ? "arrow-left-long" : "arrow-right-long"}
                        className="ms-3 text-xl w-6 text-primary"
                      />
                    </span>
                  </Link>
