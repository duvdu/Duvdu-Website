        ...
        <>
                <Popup id='alarm' >
                    <div className='flex flex-col justify-center items-center max-w-[828px] md:px-14'>
                        ...
                        <h1 className='text-3xl opacity-80 font-extrabold capitalize max-w-[400px] text-center'>{t("your post goes against our guidelines")}</h1>
