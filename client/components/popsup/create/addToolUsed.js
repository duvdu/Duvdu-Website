            ...
            <Comman id={"AddToolUsed"} header={"Add Tool Used"} onCancel={onCancel}>
                <div className='flex flex-col justify-between h-full'>
                    <div className='flex flex-col gap-2'>
                        <InputFeid placeholder={t("tool name...")} onChange={handlenameChange} errerMsg={error.name} sendValue={name}/>
                        <InputFeid type='number' placeholder={t("unitPrice")} onChange={handleFeesChange} errerMsg={error.unitPrice } sendValue={unitPrice}/>
                    </div>
                    <div  onClick={onclick}>
