    ...
    return (
        ...
        >
            <div className="w-full flex justify-center items-center">
                <span className="capitalize flex mx-2 lg:mx-5 items-center text-base sm:text-lg font-bold text-DS_white text-center text-white whitespace-nowrap">{text}</span>
            </div>
