...
const Search = ({ categories, close , SetheaderPopUp}) => {
    ...
    return (
        <>
            <div className="flex gap-2 h-14">
                <input
                    ...
                    onBlur={() => {
                        ...
                        handleSearch(); // Trigger search on blur
                    }}
            ...
            <div>
                <h4 className="text-lg font-medium opacity-80 mt-12 mb-5">{t("Suggestions")}</h4>
