            ...
            <form className="">
                ...
                <div className='md:flex items-center justify-between gap-4 mb-6'>
                    ...
                    <input
                        type="text"
                        id="cardOwner"
                        className={`border border-gray-300 rounded-xl w-full py-2 px-3 text-black focus:outline-none focus:ring-indigo-500 focus:ring-width-2 focus:border-primary focus:border-4 ${cardOwnerError ? 'border-red-500' : ''}`}
                        value={cardOwner|| ""}
