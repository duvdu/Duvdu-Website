            ...
            <div className='flex flex-col gap-3 items-start justify-between w-full'>
                ...
                <div className='flex flex-col xl:flex-row justify-between items-center w-full gap-3'>
                    <div className='flex gap-3 w-full'>
                        <span className='text-[40px] flex items-center ml-3 gap-2'>  <span className='opacity-50 text-white'>{t('egp_currency')}</span> <span className='text-white'>{data?.contract?.totalPrice}</span> </span>
