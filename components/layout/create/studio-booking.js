...
import SetCover from "./addCover";


const AddStudioBooking = ({ StudioBooking, user, auth, respond, categories, addprojectState, UpdateFormData, InsertToArray, resetForm }) => {
    ...
    return (
        <Layout>
            <Successfully_posting isShow={post_success} onCancel={reset} />
            ...
            {nextstep == 2 ? (
                ...
                (
                    <form className='flex flex-col gap-5 container mx-auto'>
                        ...
                        <div className="mx-auto w-full flex max-w-96 my-12">
                            <div onClick={cancel} className='flex rounded-full header-border p-4 cursor-pointer justify-center items-center'>
                        ...
                        <Button onClick={setCover} className="w-full mb-7 mt-4 max-w-96 mx-auto" shadow={true} shadowHeight={"14"}>
