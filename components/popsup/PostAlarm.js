        ...
        <>
                <Popup id='alarm' >
                    <div className='flex flex-col justify-center items-center max-w-[828px] px-14'>
                        <Icon name={"alarm"} className="mb-8" />
                        ...
                        <div className='mt-7 border-alarm w-full h-36 bg-[#EAEEF0] rounded-3xl p-3 overflow-y-scroll'>
                            <div className='h-36'>
                        ...
                        <AppButton text={"ok"} className={"mt-14 mx-16 md:mx-32 px-20 sm:px-36"} />
