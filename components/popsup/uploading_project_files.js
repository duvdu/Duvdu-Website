                ...
                <div className='flex flex-col justify-center items-center p-0 sm:px-52 '>
                    <div className='max-w-[400px]'>
                        <section>
                            ...
                            <input placeholder="example: google drive link..." className="google-drive-link bg-[#9999991A] rounded-3xl border-black border-opacity-10 h-16 sm:w-96 mt-4 p-4 placeholder:capitalize placeholder:opacity-30 placeholder:text-DS_black" />
                        </section>
                        <section>
                            <p className="capitalize opacity-60 mt-11">Note <span className='opacity-30 text-xs '> “optional” </span></p>
                            <textarea placeholder="start typing..." className="bg-[#9999991A] rounded-3xl border-black border-opacity-10 mt-4 h-44 placeholder:capitalize placeholder:opacity-30 placeholder:text-DS_black" />
                        </section>
