...
const Drawer = ({ isOpen, toggleDrawer, img, name, children, className = "" }) => {
    ...
    return (
        <>
            ...
            <div className={`z-20 fixed top-0 right-0 h-full bg-DS_white shadow-lg transform transition-transform ease-in-out duration-300  ${isOpen ? 'translate-x-0' : 'translate-x-full'} ${className} w-full md:w-2/3 lg:w-1/2 xl:w-1/3 min-w-[700px]`}>
                <div className="p-8">
