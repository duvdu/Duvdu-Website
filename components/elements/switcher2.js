...
const Switch = ({ onSwitchChange,defaultValue }) => {
  ...
  return (
    <div className={`w-[58px] h-[30px] p-1 rounded-full relative cursor-pointer ${isFreedom ? 'bg-[#ADD2E9]' : 'bg-transparent border border-[#4972AA]'}`} onClick={handleSwitchClick}>
