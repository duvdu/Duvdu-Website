    ...
    <div className={`border border-50 border-solid border-gray-300 p-10 ${className}`}>
      <div className='flex items-center justify-center text-center pb-5'>
        ...
        <div className='flex-2 flex-col gap-1'>
          <h3 className='opacity-80 text-lg font-bold text-start'>{cardData.name}</h3>
      ...
      <div className='flex justify-between mt-7'>
        <div>
          ...
          <span className='text-5xl font-medium'>{cardData.pricing} $</span>
        </div>
        <div className='w-[1px] bg-black opacity-15' />
        <div>
          <p className='text-sm capitalize opacity-50 leading-8'>duration</p>
          <span className='text-5xl font-medium'>{cardData.duration} hours</span>
        </div>
      </div>
